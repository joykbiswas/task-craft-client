    ...
    <div>
      <div className=" bg-cover min-h-screen"
        ...
        <div className="flex   md:h-[70vh] lg:h-[80vh] ">
          <div className="w-3/5 ml-4 lg:ml-6 pt-2 space-y-3 md:pt-3 md:space-y-5 lg:pt-5 lg:space-y-9  items-center ">
            <h5 className="text-5xl font-semibold text-yellow-500 pt-12 md:pt-24 lg:pt-24 ">
